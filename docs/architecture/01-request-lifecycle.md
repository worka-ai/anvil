...
3. The node writes object bytes into Anvil-owned storage and records the resulting content hash, shard map, object metadata, version id, mutation id, and authorization revision in the native metadata journal.
