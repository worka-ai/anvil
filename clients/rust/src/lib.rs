...
pub mod proto {
    pub use super::generated::{
        ...
        GetAuthzSchemaRequest, GetAuthzSchemaResponse, GetBucketPolicyRequest,
        ...
        GetPersonalDbGroupRequest, GetPersonalDbProjectionRequest, GetTensorChunk,
        GetTensorRequest, GetTensorsRequest, GitBlobLocation, GitPackMetadata, GitTreeEntryRecord,
