...
pub mod proto {
    pub use super::generated::{
        ...
        ApplyAuthzSchemaRequest, ApplyAuthzSchemaResponse, AuthzNamespaceSchema, AuthzRelationRule,
        AuthzRelationSchema, AuthzSchemaRef, AuthzScope, AuthzSubject, AuthzTuple,
        AuthzTupleMutation, BindAuthzSchemaRequest, BindAuthzSchemaResponse, Bucket,
        ...
        CompareAndSwapManifestRequest, CompareAndSwapManifestResponse, CompleteMultipartPart,
        CompleteMultipartRequest, CompleteMultipartResponse, ComposeObjectRequest,
        ComposeObjectResponse, ComposeObjectSource, CopyObjectRequest, CopyObjectResponse,
        CreateAppendStreamRequest, CreateAppendStreamResponse, CreateBucketRequest,
        CreateBucketResponse, CreateHfKeyRequest, CreateHfKeyResponse, CreateIndexRequest,
        ...
        GetObjectResponse, GetPersonalDbGroupRequest, GetPersonalDbProjectionRequest,
        GetTensorChunk, GetTensorRequest, GetTensorsRequest, GitBlobLocation, GitPackMetadata,
        ...
        ListTensorsRequest, ListTensorsResponse, ModelManifest, MutationBatchAppendStreamRecord,
        MutationBatchCheckpointTaskLease, MutationBatchCommitTaskLease,
        MutationBatchCompareAndSwapManifest, MutationBatchDeleteObject, MutationBatchOperation,
        MutationBatchOperationReceipt, MutationBatchPatchJsonObject, MutationBatchPutObject,
        MutationBatchRequest, MutationBatchResponse, NativeMutationContext, ObjectInfo,
        ObjectMetadata, ObjectRef, ObjectSummary, ObjectVersionPrecondition, ObjectVersionSummary,
        ...
        QueryIndexResponse, ReadAppendStreamRequest, ReadAppendStreamResponse,
        ReadAuthzTuplesRequest, ReadAuthzTuplesResponse, ReadTaskLeaseRequest,
        ...
        TaskLease, TaskLeaseResponse, TenantScope, TensorIndexRow, UpdateIndexRequest,
        UploadPartMetadata, UploadPartRequest, UploadPartResponse, WatchAuthzDerivedLagRequest,
        ...
        WriteAuthzTuplesResponse, WritePrecondition, auth_service_client, bucket_service_client,
        ...
        model_manifest, model_service_client, object_service_client, personal_db_service_client,
        put_git_pack_request, put_object_request, repair_service_client, upload_part_request,
    };
}
