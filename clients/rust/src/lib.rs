...
pub mod proto {
    pub use super::generated::{
        ...
        AuthzSubject, AuthzTuple, AuthzTupleMutation, Bucket, CancelHfIngestionRequest,
        ...
        GetAccessTokenRequest, GetAccessTokenResponse, GetAuthzSchemaRequest,
        ...
        PutObjectResponse, QueryIndexRequest, QueryIndexResponse, ReadAuthzTuplesRequest,
        ReadAuthzTuplesResponse, ReadTaskLeaseRequest, ReadTaskLeaseResponse,
