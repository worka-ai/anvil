...
pub mod proto {
    pub use super::generated::{
        ...
        AppendStreamRecordRequest, AppendStreamRecordResponse, AuthzSubject, AuthzTuple,
        AuthzTupleMutation, Bucket, CancelHfIngestionRequest, CancelHfIngestionResponse,
        CheckPermissionRequest, CheckPermissionResponse, CheckPermissionsRequest,
        CheckPermissionsResponse, CheckpointTaskLeaseRequest, CompareAndSwapManifestRequest,
        ...
        InitiateMultipartRequest, InitiateMultipartResponse, ListAuthzObjectsRequest,
