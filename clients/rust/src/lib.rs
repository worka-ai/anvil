...
pub mod proto {
    pub use super::generated::{
        ...
        CreatePersonalDbGroupRequest, DType, DeleteApplicationCredentialRequest,
        ...
        GetPersonalDbProjectionRequest, GetSagaRequest, GetStorageClassRequest, GetTensorChunk,
        GetTensorRequest, GetTensorsRequest, GetTransactionRequest, GitBlobLocation,
        GitPackMetadata, GitTreeEntryRecord, GrantAccessRequest, GrantAccessResponse,
        HeadObjectRequest, HeadObjectResponse, HfKey, IndexBuildRecord, IndexDefinitionRecord,
