...
pub use meta::{
    ...
    TABLE_ADMISSION_COMMIT_CERTIFICATE_ROW, TABLE_AUTHZ_IDEMPOTENCY_RECEIPT_ROW,
    TABLE_AUTHZ_SCHEMA_ROW, TABLE_AUTHZ_TUPLE_PAGE_ROW, TABLE_BOUNDARY_MIGRATION_ROW,
    TABLE_BOUNDARY_SCHEMA_ROW, TABLE_BOUNDARY_VALUE_ROW, TABLE_BUCKET_CURRENT_BY_ID_ROW,
    TABLE_BUCKET_CURRENT_BY_NAME_ROW, TABLE_CONTROL_CURRENT_ROW, TABLE_CORE_FENCE_ROW,
    TABLE_DERIVED_INDEX_PROOF_ROW, TABLE_DIAGNOSTIC_ROW, TABLE_EXPLICIT_TRANSACTION_ROW,
    TABLE_GATEWAY_METADATA_ROW, TABLE_GIT_SOURCE_MANIFEST_ROW, TABLE_INDEX_DEFINITION_ROW,
    ...
    TABLE_TRANSACTION_LOCATOR_ROW, TABLE_WATCH_CHECKPOINT_ROW, TABLE_WRITER_SEGMENT_ROW,
