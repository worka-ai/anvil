...
For the conceptual background, keep [Learn: Overview](/learn/overview/), [Object Model](/learn/object-model/), [Authorisation](/learn/authorisation/), [Indexes and Query](/learn/indexes-and-query/), [Watches and Derived Data](/learn/watches-and-derived-data/), [Gateways](/learn/gateways/), and [Regions, Cells, and Nodes](/learn/regions-cells-and-nodes/) nearby. For implementation-level storage, index, watch, and mesh details, use [Architecture Overview](/architecture/overview/) and [Release Architecture Status](/architecture/release-status/). For exact command and permission reference, use [Public CLI](/reference/public-cli/), [Admin CLI](/reference/admin-cli/), [Authorisation Actions and Resources](/reference/authorisation-actions-and-resources/), and [Index Definitions and Query JSON](/reference/index-definitions-and-query-json/).
